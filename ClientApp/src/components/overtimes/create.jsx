...
export default class OvertimeCreate extends Component {
      ...
      <div className="mt-3">
        <form name="CreateForm">
          ...
          <div className="col-md-6 pl-0" id="participants">
            <DateGroup name="Date" value={(new Date()).toISOString().slice(0, 10)} hint="Дата переработки" />
            <OptionsInputGroup reversed name="UserId" options={this.options} hint="Сотрудник" />
          ...
          <div className="col-md-3 mt-5 pl-0">
            ...
            <button
              ...
              type="button"
              onClick={this.props.createOvertime}
            >Создать<span id="duration" className="badge badge-light ml-2"></span>
            </button>
          </div>
        </form >
      </div>
